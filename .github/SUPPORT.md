# Getting help with cctable

Thanks for using cctable. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/cctable/issues) to make sure the 
