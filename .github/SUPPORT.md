# Getting help with epitabulate

Thanks for using epitabulate. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/R4EPI/epitabulate/issues) to make sure the 
...
the R4EPI contributing guidelines.
